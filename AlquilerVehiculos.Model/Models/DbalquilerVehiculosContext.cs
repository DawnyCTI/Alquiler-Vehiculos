...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=DAWNY-CT\\SQLEXPRESS;Database=DBAlquilerVehiculos;Trusted_Connection=True;TrustServerCertificate=True;");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Categorium>(entity =>
        {
            entity.HasKey(e => e.IdCategoria).HasName("PK__Categori__8A3D240C182509AA");
        ...
        {
            entity.HasKey(e => e.IdDetalleVenta).HasName("PK__DetalleV__BFE2843FA9CD2542");
            ...
            entity.HasOne(d => d.IdVehiculoNavigation).WithMany(p => p.DetalleVenta)
                ...
                .HasConstraintName("FK__DetalleVe__idVeh__66603565");
        ...
        {
            entity.HasKey(e => e.IdMenu).HasName("PK__Menu__C26AF483F22AFEB8");
        ...
        {
            entity.HasKey(e => e.IdMenuRol).HasName("PK__MenuRol__9D6D61A4FFAB7C04");
        ...
        {
            entity.HasKey(e => e.IdNumeroDocumento).HasName("PK__NumeroDo__471E421AB5CAAF1E");
        ...
        {
            entity.HasKey(e => e.IdRol).HasName("PK__Rol__3C872F765054C640");
        ...
        {
            entity.HasKey(e => e.IdUsuario).HasName("PK__Usuario__645723A6E497445F");
        ...
        {
            entity.HasKey(e => e.IdVehiculo).HasName("PK__Vehiculo__48682970A6A5549E");
            ...
            entity.HasOne(d => d.IdCategoriaNavigation).WithMany(p => p.Vehiculos)
                ...
                .HasConstraintName("FK__Vehiculo__idCate__5AEE82B9");
        });

        modelBuilder.Entity<Ventum>(entity =>
        {
            entity.HasKey(e => e.IdVenta).HasName("PK__Venta__077D5614ED0539AA");
